...
import ExampleDesignShot from './assets/example-design-shot.png'

<Meta title="bsnkui/Introduction" />
...
<img src={ExampleDesignShot} alt="Design Example" style={{maxWidth: '600px'}}/>
